...
### Claro
Para la empresa "Claro", al igual que la empresa anterior, se realizo una serie de tiempo, asi como uso de la función auto.arima para ajustar el mejor modelo posible a los datos. Para comprobar que es un buen modelo, se hizo el test de Ljung-Box.
