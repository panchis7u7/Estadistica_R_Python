...
head(oilfilters)
#data() was originally intended to allow users to load datasets from packages for use in their examples, 
#and as such it loaded the datasets into the workspace .GlobalEnv. 
#This avoided having large datasets in memory when not in use: 
#that need has been almost entirely superseded by lazy-loading of datasets.
